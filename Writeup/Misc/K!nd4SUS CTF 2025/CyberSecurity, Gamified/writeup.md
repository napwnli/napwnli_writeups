...
# Exploit
By looking at the website requests, we can see the one which interprets the gblorb payload:
...
By searching the string "KSUS" in the decompiled.txt, we can obtain the flag:
